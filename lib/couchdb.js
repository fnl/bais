 ...
 * @param {boolean} raw response; optional
 */
CouchClient.prototype.post = function (options, data, callback, raw) {
 ...
 * @param {boolean} raw response; optional
 */
CouchClient.prototype.put = function (options, data, callback, raw) {
 ...
 *
 * NB: options can have an additional "params" property object with
 * query parameters that will be appended to the path.
 *
 * @param {Object} options
